...
export default function ReviewsPage() {
  ...
  const filteredReviews = useMemo(() => {
    ...
    const result = reviews.filter((review) => {
      ...
      if (source !== 'all' && source !== review.source) return false;
