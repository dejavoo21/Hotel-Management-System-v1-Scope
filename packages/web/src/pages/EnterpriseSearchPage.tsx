        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px] xl:gap-5">
          ...
          <aside className="hidden space-y-3 xl:block">
            ...
            <section className="rounded-xl border border-primary-100 bg-primary-50/40 p-5 shadow-sm">
              <div className="flex items-center justify-between"><div><h2 className="flex items-center gap-2 text-xs font-bold"><Sparkles className="h-4 w-4 text-primary-700" />AI Insight</h2><p className="mt-1 text-[9px] text-text-muted">Evidence-backed insight from authorised context.</p></div><ChevronUp className="h-4 w-4 text-slate-500" /></div>
