                      ...
                      <tr className={rowClasses(status)}>
                        ...
                        <td className="px-5 py-3">
                          <div className="flex flex-wrap justify-end gap-2">
                            ...
                            <span className="ml-1 border-l border-border pl-2"><button type="button" onClick={() => setConfirmAction({ type: 'delete', request })} className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-rose-300 text-rose-600 transition hover:bg-rose-50" aria-label={`Delete request from ${request.fullName}`} title="Delete request"><Trash2 className="h-4 w-4" /></button></span>
                          </div>
                        </td>
                      </tr>
