...
// Centralized icon component for navigation
export const NavIcon = memo(function NavIcon({ name, className = 'h-5 w-5' }: IconProps) {
  const icons: Record<string, JSX.Element> = {
    ...
    gauge: (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.5a9 9 0 00-9 9v1.5a3 3 0 003 3h12a3 3 0 003-3V13.5a9 9 0 00-9-9z" />
