    ...
    <div data-dashboard-view={roleView} className="min-h-full bg-transparent">
      <div className="mx-auto w-full max-w-[2200px] space-y-3">
        ...
        <div className="grid gap-3 [grid-template-columns:repeat(auto-fit,minmax(240px,1fr))]" data-testid="dashboard-smart-actions">
          ...
          {canViewBookings ? <SmartAction icon={SparklesIcon} title="Hotel Insights" description="Review connected hotel information and AI recommendations." cta="Open insights" tone="blue" onClick={() => navigate('/ai/hotel-brain')} /> : null}
        ...
        <div className="grid gap-3 2xl:grid-cols-[minmax(0,1fr)_clamp(300px,18vw,340px)] 2xl:gap-4">
          ...
          <aside className="flex min-w-0 flex-col gap-3" data-testid="dashboard-right-rail">
            ...
            <Surface className="overflow-hidden">
              <div className="theme-widget-header px-4 py-3"><div className="flex items-center gap-2"><SparklesIcon className="h-4 w-4 opacity-80" /><h2 className="text-xs font-bold">Operational attention</h2></div><p className="mt-1 text-[9px] opacity-70">Authorised live priorities and Hotel Insights guidance</p></div>
