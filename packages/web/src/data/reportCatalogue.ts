...
export const REPORT_CATALOGUE: ReportCatalogueItem[] = [
  ...
  { id: 'ai', name: 'Hotel Brain recommendations', description: 'Authorised operational recommendations and management insights.', category: 'AI / Hotel Brain', access: 'bookings', route: '/ai/hotel-brain', formats: ['PDF'], source: 'Prepared view' },
